          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {featuredChefs.map((chef, i) => (
                <Reveal key={chef.id} delay={i * 120}>
                  <Link href={`/chefs/${chef.id}`} className="group block">
                    <div className="bg-white rounded-2xl overflow-hidden border transition-all duration-300 hover:shadow-2xl hover:-translate-y-1" style={{ borderColor: 'var(--border)' }}>
